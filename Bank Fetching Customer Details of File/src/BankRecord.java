...
public class BankRecord extends client
{
	...
	private String id,region,sex,married,save_acct,current_act,mortage,pep,car;
...
public void readData()
	...
	rObj[i].setCar(dbData.get(5));
	rObj[i].setChildren(Integer.parseInt(dbData.get(6)));
	rObj[i].setSave_acct(dbData.get(7));
	rObj[i].setCurrent_act(dbData.get(8));
	rObj[i].setMortage(dbData.get(9));
	rObj[i].setPep(dbData.get(10));	
